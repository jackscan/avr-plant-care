...
#define MA_SENS_DDR DDRB
#define MA_SENS_PORT PORTB
#define MA_SENS_PIN PINB
#define MA_SENSA_BIT (1 << PB2)
#define MA_SENSB_BIT (1 << PB3)
#define MA_SENS_PCMSK PCMSK0
#define MA_SENS_PCIE PCIE0
#define MA_SENS_PCINT_VECT PCINT0_vect
#define MA_SENSA_PCINT PCINT2
#define MA_SENSB_PCINT PCINT3
